...
public class DELETEInputMessageInputParameterHandler
{
    ...
    DELETEInputMessageInputParameterHandler(int inputParameterId, UriInfo applicationUri)
    {
    ...
    public InputParameterModel createHypermediaURIs(InputParameterModel oInputParameter)
    {
        ...
        oInputParameter.getLinkList().add(new Link(String.format("%s%s",oApplicationUri.getBaseUri(),oApplicationUri.getPath()).substring(0, iLastSlashIndex),"Read all InputParameter of this InputMessage","GET","Parent"));
