...
public class POSTResourceRESTParameterHandler
{
    ...
    public RESTParameterModel createHypermediaURIs(RESTParameterModel oRESTParameter)
    {
        ...
        oRESTParameter.getLinkList().add(new Link(String.format("%s%s",oApplicationUri.getBaseUri(),oApplicationUri.getPath()).substring(0, iLastSlashIndex),"Delet Resource","DELETE","Parent"));
